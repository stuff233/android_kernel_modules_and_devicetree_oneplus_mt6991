...
enum adsp_feature_id {
	...
	EXTSTREAM1_FEATURE_ID,
	EXTSTREAM2_FEATURE_ID,
#endif
#if IS_ENABLED(CONFIG_SND_SOC_MTK_AUTO_AUDIO_DSP)
#if IS_ENABLED(CONFIG_MTK_ADSP_AUTO_MULTI_PLAYBACK_SUPPORT)
	SUB_PLAYBACK_FEATURE_ID,
#endif
	PLAYBACK0_FEATURE_ID,
	PLAYBACK1_FEATURE_ID,
	PLAYBACK2_FEATURE_ID,
	PLAYBACK3_FEATURE_ID,
	PLAYBACK4_FEATURE_ID,
	PLAYBACK5_FEATURE_ID,
	PLAYBACK6_FEATURE_ID,
	PLAYBACK7_FEATURE_ID,
	PLAYBACK8_FEATURE_ID,
	PLAYBACK9_FEATURE_ID,
	PLAYBACK10_FEATURE_ID,
	PLAYBACK11_FEATURE_ID,
	PLAYBACK12_FEATURE_ID,
	PLAYBACK13_FEATURE_ID,
	PLAYBACK14_FEATURE_ID,
	PLAYBACK15_FEATURE_ID,
	CAPTURE_MCH_FEATURE_ID,
#if IS_ENABLED(CONFIG_MTK_ADSP_AUTO_HFP_CLIENT_SUPPORT)
	HFP_CLIENT_TX_FEATURE_ID,
#endif
#endif
	ADSP_NUM_FEATURE_ID,
};
...
/* add adsp ssr function for audio daemon kernel with hifi adsp */
