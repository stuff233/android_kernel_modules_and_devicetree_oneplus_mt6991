...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846_SENSOR_ID_LIJING,
...
static int sn_flag_addr_tbl[MAX_GROUP_NUM] = {0x1866, 0x187A, 0x188E};
static int sn_data_addr_tbl[MAX_GROUP_NUM] = {0x1854, 0x1868, 0x187C};
...
unsigned char hi846_data_info[MODULE_INFO_SIZE + 2] = {0};/*Add flag and check sum*/
...
static int read_hi846_module_info(void)
{
	...
	if(minfo_start_addr != 0){
		...
		check_sum = hi846_data_info[MODULE_INFO_SIZE + 1];
...
static int read_hi846_sn_info(void)
{
	...
	if(sn_start_addr != 0){
		...
		if(check_sum_sn == check_sum_sn_cal){
			...
			pCamDeviceObj->i4CurSensorId = HI846_SENSOR_ID_LIJING;
			return 1;
		}else{
			return 0;
