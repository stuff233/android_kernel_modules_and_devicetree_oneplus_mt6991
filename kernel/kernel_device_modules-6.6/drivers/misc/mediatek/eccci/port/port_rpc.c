...
static int get_md_gpio_val(unsigned int num)
{
    ...
    if(is_project(24700) || is_project(24701) || is_project(24702) || is_project(24709) || is_project(24713) || is_project(24714) || is_project(24715) || is_project(24728) || is_project(0x226AF)|| is_project(0x226AE)|| is_project(0x226AD) ||is_project(23703)|| is_project(23704) || is_project(24777))
    {
