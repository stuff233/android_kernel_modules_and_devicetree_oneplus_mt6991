...
/* 1080p size and pixel as upper bound */
#define MML_IR_WIDTH_1080P		1920
#define MML_IR_HEIGHT_1080P	1088
#define MML_IR_1080P		(MML_IR_WIDTH_1080P * MML_IR_HEIGHT_1080P)
	...
	u32 *reason)
{
	...
	if (info->dest[0].crop.r.width > MML_IR_WIDTH_1080P ||
		info->dest[0].crop.r.height > MML_IR_HEIGHT_1080P ||
		pixel > MML_IR_1080P) {
