...
/*
 *  Mediatek ALSA SoC AFE platform driver for 6991
 *
...
static ssize_t mt6991_debug_read_reg(char *buffer, int size, struct mtk_base_afe *afe);

static const struct snd_pcm_hardware mt6991_afe_hardware = {
...
void mt6991_fe_shutdown(struct snd_pcm_substream *substream,
			struct snd_soc_dai *dai)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct mtk_base_afe *afe = snd_soc_dai_get_drvdata(dai);
...
static int mt6991_memif_fs(struct snd_pcm_substream *substream,
			   unsigned int rate)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	...
	rate_reg = mt6991_rate_transform(afe->dev, rate, id);

	switch (id) {
	case MT6991_MEMIF_VUL8:
	case MT6991_MEMIF_VUL_CM0:
		cm = 0x0;
		break;
	case MT6991_MEMIF_VUL9:
	case MT6991_MEMIF_VUL_CM1:
		cm = 0x1;
		break;
	case MT6991_MEMIF_VUL10:
	case MT6991_MEMIF_VUL_CM2:
		cm = 0x2;
		break;
	default:
		cm = 0x0;
	...
	mt6991_set_cm_rate(cm, rate_reg);

	return rate_reg;
}

static int mt6991_get_dai_fs(struct mtk_base_afe *afe,
			     int dai_id, unsigned int rate)
{
	return mt6991_rate_transform(afe->dev, rate, dai_id);
}

static int mt6991_irq_fs(struct snd_pcm_substream *substream, unsigned int rate)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	if (!component)
		return -EINVAL;
	afe = snd_soc_component_get_drvdata(component);
	return mt6991_general_rate_transform(afe->dev, rate);
}

int mt6991_get_memif_pbuf_size(struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;

	if ((runtime->period_size * 1000) / runtime->rate > 10)
		return MT6991_MEMIF_PBUF_SIZE_256_BYTES;
	else
		return MT6991_MEMIF_PBUF_SIZE_32_BYTES;
}

/* FE DAIs */
static const struct snd_soc_dai_ops mt6991_memif_dai_ops = {
	.startup        = mt6991_fe_startup,
	.shutdown       = mt6991_fe_shutdown,
	.hw_params      = mtk_afe_fe_hw_params,
	.hw_free        = mtk_afe_fe_hw_free,
	.prepare        = mtk_afe_fe_prepare,
	.trigger        = mt6991_fe_trigger,
};
...
static struct snd_soc_dai_driver mt6991_memif_dai_driver[] = {
...
/* kcontrol */
static int mt6991_irq_cnt1_get(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.integer.value[0] =
		afe_priv->irq_cnt[MT6991_PRIMARY_MEMIF];
	return 0;
}

static int mt6991_irq_cnt1_set(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int memif_num = MT6991_PRIMARY_MEMIF;
	struct mtk_base_afe_memif *memif = &afe->memif[memif_num];
	int irq_id = memif->irq_usage;
...
static int mt6991_irq_cnt2_get(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	...
	ucontrol->value.integer.value[0] =
		afe_priv->irq_cnt[MT6991_RECORD_MEMIF];
	return 0;
}

static int mt6991_irq_cnt2_set(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int memif_num = MT6991_RECORD_MEMIF;
	struct mtk_base_afe_memif *memif = &afe->memif[memif_num];
	int irq_id = memif->irq_usage;
	int irq_cnt = afe_priv->irq_cnt[memif_num];
...
static int mt6991_deep_irq_cnt_get(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	...
	ucontrol->value.integer.value[0] = afe_priv->irq_cnt[MT6991_DEEP_MEMIF];
	return 0;
}

static int mt6991_deep_irq_cnt_set(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int memif_num = MT6991_DEEP_MEMIF;
	struct mtk_base_afe_memif *memif = &afe->memif[memif_num];
	int irq_id = memif->irq_usage;
	int irq_cnt = afe_priv->irq_cnt[memif_num];
...
static int mt6991_voip_rx_irq_cnt_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	...
	ucontrol->value.integer.value[0] = afe_priv->irq_cnt[MT6991_VOIP_MEMIF];
	return 0;
}

static int mt6991_voip_rx_irq_cnt_set(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int memif_num = MT6991_VOIP_MEMIF;
	struct mtk_base_afe_memif *memif = &afe->memif[memif_num];
	int irq_id = memif->irq_usage;
	int irq_cnt = afe_priv->irq_cnt[memif_num];
...
static int mt6991_deep_scene_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_deep_scene_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_fast_scene_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_fast_scene_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int memif_num = MT6991_FAST_MEMIF;
	struct mtk_base_afe_memif *memif = &afe->memif[memif_num];
...
static int mt6991_primary_scene_get(struct snd_kcontrol *kcontrol,
				    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_primary_scene_set(struct snd_kcontrol *kcontrol,
				    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_voip_scene_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_voip_scene_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_record_xrun_assert_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int xrun_assert = afe_priv->xrun_assert[MT6991_RECORD_MEMIF];

	ucontrol->value.integer.value[0] = xrun_assert;
	return 0;
}

static int mt6991_record_xrun_assert_set(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	...
	afe_priv->xrun_assert[MT6991_RECORD_MEMIF] = xrun_assert;
	return 0;
}

static int mt6991_echo_ref_xrun_assert_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int xrun_assert = afe_priv->xrun_assert[MT6991_ECHO_REF_MEMIF];

	ucontrol->value.integer.value[0] = xrun_assert;
	return 0;
}

static int mt6991_echo_ref_xrun_assert_set(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	...
	dev_info(afe->dev, "%s(), xrun_assert %d\n", __func__, xrun_assert);
	afe_priv->xrun_assert[MT6991_ECHO_REF_MEMIF] = xrun_assert;
	return 0;
}
					  ...
					  struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	int memif_num = MT6991_BARGE_IN_MEMIF;
	struct mtk_base_afe_memif *memif = &afe->memif[memif_num];
	int irq_id = memif->irq_usage;
...
static int mt6991_adsp_ref_mem_get(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adsp_ref_mem_set(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adsp_mem_get(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adsp_mem_set(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_mmap_dl_scene_set(struct snd_kcontrol *kcontrol,
				    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int memif_num = MT6991_MMAP_DL_MEMIF;
	struct mtk_base_afe_memif *memif = &afe->memif[memif_num];
...
static int mt6991_mmap_ul_scene_get(struct snd_kcontrol *kcontrol,
				    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_mmap_ul_scene_set(struct snd_kcontrol *kcontrol,
				    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	struct mt6991_afe_private *afe_priv = afe->platform_priv;
	int memif_num = MT6991_MMAP_UL_MEMIF;
	struct mtk_base_afe_memif *memif = &afe->memif[memif_num];
...
static int mt6991_mmap_ion_get(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6991_mmap_ion_set(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_dl_mmap_fd_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_dl_mmap_fd_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}

static int mt6991_ul_mmap_fd_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_ul_mmap_fd_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}
...
static const struct snd_kcontrol_new mt6991_pcm_kcontrols[] = {
	...
	SOC_SINGLE_EXT("adsp_ref_sharemem_scenario",
		       SND_SOC_NOPM, 0, 0x1, 0,
		       mt6991_adsp_ref_mem_get,
		       mt6991_adsp_ref_mem_set),
	...
	SOC_SINGLE_EXT("mmap_record_scenario", SND_SOC_NOPM, 0, 0x1, 0,
		       mt6991_mmap_ul_scene_get, mt6991_mmap_ul_scene_set),
	...
	SOC_SINGLE_EXT("aaudio_dl_mmap_fd",
		       SND_SOC_NOPM, 0, 0xffffffff, 0,
		       mt6991_dl_mmap_fd_get,
		       mt6991_dl_mmap_fd_set),
			...
			int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		mt6991_enable_cm_bypass(afe, CM0, 0x0);
			...
			int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		channels = mtk_get_channel_value();
		mt6991_enable_cm_bypass(afe, CM1, 0x0);
			...
			int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		channels = mtk_get_channel_value();
		mt6991_enable_cm_bypass(afe, CM2, 0x0);
...
static const struct snd_kcontrol_new memif_ul1_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL_24CH_CH1", AFE_CONN020_1,
				    I_DL_24CH_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL_4CH_CH1", AFE_CONN020_1,
				    I_DL_4CH_CH1, 1, 0),
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH1", AFE_CONN020_4,
				    I_I2SIN4_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH1", AFE_CONN020_4,
				    I_I2SIN5_CH1, 1, 0),
...
static const struct snd_kcontrol_new memif_ul1_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL_24CH_CH2", AFE_CONN021_1,
				    I_DL_24CH_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL_4CH_CH2", AFE_CONN021_1,
				    I_DL_4CH_CH2, 1, 0),
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH2", AFE_CONN021_4,
				    I_I2SIN4_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH2", AFE_CONN021_4,
				    I_I2SIN5_CH2, 1, 0),
...
static const struct snd_kcontrol_new memif_ul2_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("HW_SRC_1_OUT_CH1", AFE_CONN022_6,
				    I_SRC_1_OUT_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH1", AFE_CONN022_4,
				    I_I2SIN4_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH1", AFE_CONN022_4,
				    I_I2SIN5_CH1, 1, 0),
};
...
static const struct snd_kcontrol_new memif_ul2_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("HW_SRC_1_OUT_CH2", AFE_CONN023_6,
				    I_SRC_1_OUT_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH2", AFE_CONN023_4,
				    I_I2SIN4_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH2", AFE_CONN023_4,
				    I_I2SIN5_CH2, 1, 0),
};
...
static const struct snd_kcontrol_new memif_ul4_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN0_CH1", AFE_CONN026_4,
					I_I2SIN0_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH1", AFE_CONN026_4,
				    I_I2SIN4_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH1", AFE_CONN026_4,
				    I_I2SIN5_CH1, 1, 0),
...
static const struct snd_kcontrol_new memif_ul4_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN1_CH2", AFE_CONN027_4,
				    I_I2SIN1_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH2", AFE_CONN027_4,
				    I_I2SIN4_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH2", AFE_CONN027_4,
				    I_I2SIN5_CH2, 1, 0),
...
static const struct snd_kcontrol_new memif_ul7_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN2_CH1", AFE_CONN032_4,
					I_I2SIN2_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH1", AFE_CONN032_4,
				    I_I2SIN4_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH3", AFE_CONN032_4,
				    I_I2SIN4_CH3, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH1", AFE_CONN032_4,
				    I_I2SIN5_CH1, 1, 0),
};
...
static const struct snd_kcontrol_new memif_ul7_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN2_CH2", AFE_CONN033_4,
					I_I2SIN2_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH2", AFE_CONN033_4,
				    I_I2SIN4_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH4", AFE_CONN033_4,
				    I_I2SIN4_CH4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH2", AFE_CONN033_4,
				    I_I2SIN5_CH2, 1, 0),
};
...
static const struct snd_kcontrol_new memif_ul9_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("ADDA_UL_CH3", AFE_CONN036_0,
				    I_ADDA_UL_CH3, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH1", AFE_CONN036_4,
				    I_I2SIN4_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH1", AFE_CONN036_4,
				    I_I2SIN5_CH1, 1, 0),
...
static const struct snd_kcontrol_new memif_ul9_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("ADDA_UL_CH4", AFE_CONN037_0,
				    I_ADDA_UL_CH4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH2", AFE_CONN037_4,
				    I_I2SIN4_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH2", AFE_CONN037_4,
				    I_I2SIN5_CH2, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm1_ch5_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("ADDA_UL_CH6", AFE_CONN052_0,
				    I_ADDA_UL_CH6, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH3", AFE_CONN052_4,
				    I_I2SIN4_CH3, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH5", AFE_CONN052_4,
				    I_I2SIN4_CH5, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm1_ch6_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("ADDA_UL_CH6", AFE_CONN053_0,
				    I_ADDA_UL_CH6, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH4", AFE_CONN053_4,
				    I_I2SIN4_CH4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH6", AFE_CONN053_4,
				    I_I2SIN4_CH6, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm1_ch7_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("ADDA_UL_CH4", AFE_CONN054_0,
				    I_ADDA_UL_CH4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH5", AFE_CONN054_4,
				    I_I2SIN4_CH5, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH7", AFE_CONN054_4,
				    I_I2SIN4_CH7, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm1_ch8_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("ADDA_UL_CH4", AFE_CONN055_0,
				    I_ADDA_UL_CH4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH6", AFE_CONN055_4,
				    I_I2SIN4_CH6, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH8", AFE_CONN055_4,
				    I_I2SIN4_CH8, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm1_ch9_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("ADDA_UL_CH4", AFE_CONN056_0,
				    I_ADDA_UL_CH4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH7", AFE_CONN056_4,
				    I_I2SIN4_CH7, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm1_ch10_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("ADDA_UL_CH4", AFE_CONN057_0,
				    I_ADDA_UL_CH4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH8", AFE_CONN057_4,
				    I_I2SIN4_CH8, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("HW_SRC_0_OUT_CH1", AFE_CONN064_6,
				    I_SRC_0_OUT_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH1", AFE_CONN064_4, I_I2SIN4_CH1, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("HW_SRC_0_OUT_CH2", AFE_CONN065_6,
				    I_SRC_0_OUT_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH2", AFE_CONN065_4, I_I2SIN4_CH2, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch3_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH3", AFE_CONN066_4, I_I2SIN4_CH3, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch4_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH4", AFE_CONN067_4, I_I2SIN4_CH4, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch5_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH5", AFE_CONN068_4, I_I2SIN4_CH5, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch6_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH6", AFE_CONN069_4, I_I2SIN4_CH6, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch7_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH7", AFE_CONN070_4, I_I2SIN4_CH7, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch8_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN4_CH8", AFE_CONN071_4, I_I2SIN4_CH8, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch9_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH1", AFE_CONN072_4, I_I2SIN5_CH1, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch10_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH2", AFE_CONN073_4, I_I2SIN5_CH2, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch11_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH3", AFE_CONN074_5, I_I2SIN5_CH3, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch12_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH4", AFE_CONN075_5, I_I2SIN5_CH4, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch13_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH5", AFE_CONN076_5, I_I2SIN5_CH5, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch14_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH6", AFE_CONN077_5, I_I2SIN5_CH6, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch15_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH7", AFE_CONN078_5, I_I2SIN5_CH7, 1, 0),
...
static const struct snd_kcontrol_new memif_ul_cm2_ch16_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I2SIN5_CH8", AFE_CONN079_5, I_I2SIN5_CH8, 1, 0),
...
static const struct snd_soc_dapm_route mt6991_memif_routes[] = {
	{"UL0", NULL, "UL0_CH1"},
	{"UL0", NULL, "UL0_CH2"},
	/* Normal record */
	...
	{"UL1_CH1", "DL_4CH_CH1", "Hostless_UL1 UL"},
	{"UL1_CH2", "DL_4CH_CH2", "Hostless_UL1 UL"},
	...
	{"UL1_CH1", "I2SIN5_CH1", "I2SIN5"},
	{"UL1_CH2", "I2SIN5_CH2", "I2SIN5"},
	...
	{"UL2_CH1", "I2SIN4_CH1", "I2SIN4"},
	{"UL2_CH2", "I2SIN4_CH2", "I2SIN4"},
	{"UL2_CH1", "I2SIN5_CH1", "I2SIN5"},
	{"UL2_CH2", "I2SIN5_CH2", "I2SIN5"},
	...
	{"UL4_CH1", "I2SIN4_CH1", "I2SIN4"},
	{"UL4_CH2", "I2SIN4_CH2", "I2SIN4"},
	{"UL4_CH1", "I2SIN5_CH1", "I2SIN5"},
	{"UL4_CH2", "I2SIN5_CH2", "I2SIN5"},
	...
	{"UL7_CH1", "ADDA_UL_CH5", "ADDA_CH56_UL_Mux"},
	{"UL7_CH1", "ADDA_UL_CH6", "ADDA_CH56_UL_Mux"},
	...
	{"UL7_CH2", "ADDA_UL_CH5", "ADDA_CH56_UL_Mux"},
	{"UL7_CH2", "ADDA_UL_CH6", "ADDA_CH56_UL_Mux"},

	{"UL7_CH1", "CONNSYS_I2S_CH1", "Connsys I2S"},
	{"UL7_CH2", "CONNSYS_I2S_CH2", "Connsys I2S"},
	{"UL7_CH1", "I2SIN2_CH1", "I2SIN2"},
	{"UL7_CH2", "I2SIN2_CH2", "I2SIN2"},
	{"UL7_CH1", "I2SIN4_CH1", "I2SIN4"},
	{"UL7_CH2", "I2SIN4_CH2", "I2SIN4"},
	{"UL7_CH1", "I2SIN4_CH3", "I2SIN4"},
	{"UL7_CH2", "I2SIN4_CH4", "I2SIN4"},
	{"UL7_CH1", "HW_GAIN0_OUT_CH1", "HW Gain 0 Out"},
	{"UL7_CH2", "HW_GAIN0_OUT_CH2", "HW Gain 0 Out"},
	{"UL7_CH1", "I2SIN5_CH1", "I2SIN5"},
	{"UL7_CH2", "I2SIN5_CH2", "I2SIN5"},
	...
	/* I2SIN4 CH1 ~ CH8 -> CM1 CH1 ~ CH8*/
	{"UL_CM1_CH1", "I2SIN4_CH1", "I2SIN4"},
	{"UL_CM1_CH2", "I2SIN4_CH2", "I2SIN4"},
	{"UL_CM1_CH3", "I2SIN4_CH3", "I2SIN4"},
	{"UL_CM1_CH4", "I2SIN4_CH4", "I2SIN4"},
	{"UL_CM1_CH5", "I2SIN4_CH5", "I2SIN4"},
	{"UL_CM1_CH6", "I2SIN4_CH6", "I2SIN4"},
	{"UL_CM1_CH7", "I2SIN4_CH7", "I2SIN4"},
	{"UL_CM1_CH8", "I2SIN4_CH8", "I2SIN4"},

	/* I2SIN4 CH3 ~ CH8 -> CM1 CH5 ~ CH10*/
	{"UL_CM1_CH5", "I2SIN4_CH3", "I2SIN4"},
	{"UL_CM1_CH6", "I2SIN4_CH4", "I2SIN4"},
	{"UL_CM1_CH7", "I2SIN4_CH5", "I2SIN4"},
	{"UL_CM1_CH8", "I2SIN4_CH6", "I2SIN4"},
	{"UL_CM1_CH9", "I2SIN4_CH7", "I2SIN4"},
	{"UL_CM1_CH10", "I2SIN4_CH8", "I2SIN4"},
	...
	{"UL9_CH1", "I2SIN4_CH1", "I2SIN4"},
	{"UL9_CH1", "I2SIN5_CH1", "I2SIN5"},
	...
	{"UL9_CH2", "I2SIN4_CH2", "I2SIN4"},
	{"UL9_CH2", "I2SIN5_CH2", "I2SIN5"},
	...
	/* I2SIN4 CH1 ~ CH8 -> CM2 CH1 ~ CH8*/
	{"UL_CM2_CH1", "I2SIN4_CH1", "I2SIN4"},
	{"UL_CM2_CH2", "I2SIN4_CH2", "I2SIN4"},
	{"UL_CM2_CH3", "I2SIN4_CH3", "I2SIN4"},
	{"UL_CM2_CH4", "I2SIN4_CH4", "I2SIN4"},
	{"UL_CM2_CH5", "I2SIN4_CH5", "I2SIN4"},
	{"UL_CM2_CH6", "I2SIN4_CH6", "I2SIN4"},
	{"UL_CM2_CH7", "I2SIN4_CH7", "I2SIN4"},
	{"UL_CM2_CH8", "I2SIN4_CH8", "I2SIN4"},

	/* I2SIN5 CH1 ~ CH8 -> CM2 CH9 ~ CH16*/
	{"UL_CM2_CH9", "I2SIN5_CH1", "I2SIN5"},
	{"UL_CM2_CH10", "I2SIN5_CH2", "I2SIN5"},
	{"UL_CM2_CH11", "I2SIN5_CH3", "I2SIN5"},
	{"UL_CM2_CH12", "I2SIN5_CH4", "I2SIN5"},
	{"UL_CM2_CH13", "I2SIN5_CH5", "I2SIN5"},
	{"UL_CM2_CH14", "I2SIN5_CH6", "I2SIN5"},
	{"UL_CM2_CH15", "I2SIN5_CH7", "I2SIN5"},
	{"UL_CM2_CH16", "I2SIN5_CH8", "I2SIN5"},
...
static const int memif_irq_usage[MT6991_MEMIF_NUM] = {
	...
	[MT6991_MEMIF_DL0] = MT6991_IRQ_4,
	[MT6991_MEMIF_DL1] = MT6991_IRQ_1,
	[MT6991_MEMIF_DL2] = MT6991_IRQ_2,
	[MT6991_MEMIF_DL3] = MT6991_IRQ_3,
	[MT6991_MEMIF_DL4] = MT6991_IRQ_24,
	[MT6991_MEMIF_DL5] = MT6991_IRQ_25,
	...
	[MT6991_MEMIF_DL_4CH] = MT6991_IRQ_5,
...
static const struct regmap_config mt6991_afe_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static irqreturn_t mt6991_afe_irq_handler(int irq_id, void *dev)
{
...
static int mt6991_afe_runtime_suspend(struct device *dev)
{
...
skip_regmap:
	mt6991_afe_sram_release(afe);
	mt6991_afe_disable_clock(afe);
	return 0;
}

static int mt6991_afe_runtime_resume(struct device *dev)
{
	struct mtk_base_afe *afe = dev_get_drvdata(dev);
	int ret = 0;
...
static int mt6991_afe_pcm_copy(struct snd_pcm_substream *substream,
				      ...
				      enum mtk_audio_sram_mode sram_mode)
{
	...
	regmap_update_bits(afe->regmap, AFE_DL26_CON0,
			   DL26_NORMAL_MODE_MASK_SFT,
			   reg_bit << DL26_NORMAL_MODE_SFT);
	regmap_update_bits(afe->regmap, AFE_DL_24CH_CON0,
			   DL_24CH_NORMAL_MODE_MASK_SFT,
			   reg_bit << DL_24CH_NORMAL_MODE_SFT);
	regmap_update_bits(afe->regmap, AFE_DL_4CH_CON0,
			   DL_4CH_NORMAL_MODE_MASK_SFT,
			   reg_bit << DL_4CH_NORMAL_MODE_SFT);
	...
	regmap_update_bits(afe->regmap, AFE_VUL26_CON0,
			   VUL26_NORMAL_MODE_MASK_SFT,
			   reg_bit << VUL26_NORMAL_MODE_SFT);
				...
				enum mtk_audio_sram_mode sram_mode)
{
	...
	/* set memif sram mode */
	mt6991_set_memif_sram_mode(dev, sram_mode);
...
static const struct mtk_audio_sram_ops mt6991_sram_ops = {
	.set_sram_mode = mt6991_set_sram_mode,
};
				    ...
				    char *buf, loff_t offset, size_t size)
{
	...
	read_size = mt6991_debug_read_reg(buffer, AFE_SYS_DEBUG_SIZE, afe);
...
#if IS_ENABLED(CONFIG_OPLUS_FEATURE_MM_FEEDBACK)
static ssize_t afe_reg_write(struct file *filp, const char __user *buf,
...
static ssize_t afe_reg_read(struct file *filp, char __user *buf,
				size_t count, loff_t *ppos)
{
	size_t read_size, ceil_size, page_mask;
	struct mtk_base_afe *afe = (struct mtk_base_afe *)filp->private_data;
	ssize_t ret;
	char *buffer = NULL; /* for reduce kernel stack */

	if (afe == NULL) {
		pr_info("%s afe is null\n", __func__);
		return -1;
	}

	buffer = kzalloc(AFE_SYS_DEBUG_SIZE, GFP_KERNEL);
	if (!buffer) {
	...
	ret = copy_to_user_buf_request(buf, AFE_SYS_DEBUG_SIZE, buffer,
...
static const struct proc_ops afe_reg_fops = {
	.proc_write = afe_reg_write,
	.proc_read  = afe_reg_read,
	.proc_open  = simple_open,
};
#endif /* CONFIG_OPLUS_FEATURE_MM_FEEDBACK */

static int mt6991_afe_component_probe(struct snd_soc_component *component)
{
	struct mtk_base_afe *afe = NULL;
	...
	if (component) {
		...
		mt6991_add_misc_control(component);
...
#if IS_ENABLED(CONFIG_OPLUS_FEATURE_MM_FEEDBACK)
		d_entry = proc_create_data("afe_reg", 0664, NULL, &afe_reg_fops, afe);
		if (!d_entry) {
			pr_info("%s: failed to create node\n", __func__);
		} else {
			pr_info("%s proc/afe_reg create success\n", __func__);
		}
#endif /* CONFIG_OPLUS_FEATURE_MM_FEEDBACK */
	}
...
static const struct snd_soc_component_driver mt6991_afe_component = {
	.name = AFE_PCM_NAME,
	.probe = mt6991_afe_component_probe,
...
static ssize_t mt6991_debug_read_reg(char *buffer, int size, struct mtk_base_afe *afe)
{
	...
	if (afe_priv->cksys_ck) {
		regmap_read(afe_priv->cksys_ck, CLK_CFG_13, &value);
		n += scnprintf(buffer + n, size - n,
				"CLK_CFG_13 = 0x%x\n", value);
		regmap_read(afe_priv->cksys_ck, CLK_CFG_UPDATE1, &value);
		n += scnprintf(buffer + n, size - n,
				"CLK_CFG_UPDATE1 = 0x%x\n", value);
		regmap_read(afe_priv->cksys_ck, CLK_AUDDIV_0, &value);
		n += scnprintf(buffer + n, size - n,
				"CLK_AUDDIV_0 = 0x%x\n", value);
		regmap_read(afe_priv->cksys_ck, CLK_AUDDIV_2, &value);
		n += scnprintf(buffer + n, size - n,
				"CLK_AUDDIV_2 = 0x%x\n", value);
		regmap_read(afe_priv->cksys_ck, CLK_AUDDIV_5, &value);
		n += scnprintf(buffer + n, size - n,
				"CLK_AUDDIV_5 = 0x%x\n", value);
	}
	if (afe_priv->vlp_ck) {
		...
		regmap_read(afe_priv->vlp_ck, VLP_AP_PLL_CON3, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_AP_PLL_CON3 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL1_CON0, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL1_CON0 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL1_CON1, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL1_CON1 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL1_CON2, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL1_CON2 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL1_CON4, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL1_CON4 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL2_CON0, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL2_CON0 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL2_CON1, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL2_CON1 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL2_CON2, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL2_CON2 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL2_CON4, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL2_CON4 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL1_TUNER_CON0, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL1_TUNER_CON0 = 0x%x\n", value);
		regmap_read(afe_priv->vlp_ck, VLP_APLL2_TUNER_CON0, &value);
		n += scnprintf(buffer + n, size - n,
				"VLP_APLL2_TUNER_CON0 = 0x%x\n", value);
	}
#endif
	...
	regmap_read(afe->regmap, AFE_DL_4CH_BASE_MSB, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL_4CH_BASE_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL_4CH_BASE, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL_4CH_BASE = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL_4CH_CUR_MSB, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL_4CH_CUR_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL_4CH_CUR, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL_4CH_CUR = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL_4CH_END_MSB, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL_4CH_END_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL_4CH_END, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL_4CH_END = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL_4CH_CON0, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL_4CH_CON0 = 0x%x\n", value);
	...
	n += scnprintf(buffer + n, size - n,
		"AFE_DL25_CON0 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_BASE_MSB, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_BASE_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_BASE, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_BASE = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_CUR_MSB, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_CUR_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_CUR, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_CUR = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_END_MSB, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_END_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_END, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_END = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_RCH_MON, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_RCH_MON = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_LCH_MON, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_LCH_MON = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL26_CON0, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_DL26_CON0 = 0x%x\n", value);
	...
	regmap_read(afe->regmap, AFE_VUL26_BASE, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_VUL26_BASE = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_VUL26_CUR_MSB, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_VUL26_CUR_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_VUL26_CUR, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_VUL26_CUR = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_VUL26_END_MSB, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_VUL26_END_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_VUL26_END, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_VUL26_END = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_VUL26_CON0, &value);
	n += scnprintf(buffer + n, size - n,
		"AFE_VUL26_CON0 = 0x%x\n", value);
...
static ssize_t mt6991_debugfs_read(struct file *file, char __user *buf,
				   size_t count, loff_t *pos)
{
	...
	n = mt6991_debug_read_reg(buffer, size, afe);
...
static const struct mtk_afe_debug_cmd mt6991_debug_cmds[] = {
	MTK_AFE_DBG_CMD("write_reg", mtk_afe_debug_write_reg),
	{}
};

static const struct file_operations mt6991_debugfs_ops = {
	.open = mtk_afe_debugfs_open,
	.write = mtk_afe_debugfs_write,
	.read = mt6991_debugfs_read,
};
#endif

static int mt6991_dai_memif_register(struct mtk_base_afe *afe)
{
	...
	dai->dai_drivers = mt6991_memif_dai_driver;
	dai->num_dai_drivers = ARRAY_SIZE(mt6991_memif_dai_driver);

	dai->controls = mt6991_pcm_kcontrols;
	dai->num_controls = ARRAY_SIZE(mt6991_pcm_kcontrols);
	dai->dapm_widgets = mt6991_memif_widgets;
	dai->num_dapm_widgets = ARRAY_SIZE(mt6991_memif_widgets);
	dai->dapm_routes = mt6991_memif_routes;
	dai->num_dapm_routes = ARRAY_SIZE(mt6991_memif_routes);
	return 0;
}

typedef int (*dai_register_cb)(struct mtk_base_afe *);
static const dai_register_cb dai_register_cbs[] = {
	mt6991_dai_adda_register,
	mt6991_dai_i2s_register,
	mt6991_dai_hw_gain_register,
	mt6991_dai_src_register,
	mt6991_dai_pcm_register,
	mt6991_dai_tdm_register,
	mt6991_dai_hostless_register,
	mt6991_dai_memif_register,
};

static int mt6991_afe_pcm_dev_probe(struct platform_device *pdev)
{
	int ret, i;
	unsigned int tmp_reg = 0;
#if !defined(IS_FPGA_EARLY_PORTING) || defined(FORCE_FPGA_ENABLE_IRQ)
	...
	afe->memif_size = MT6991_MEMIF_NUM;
	...
	afe->memif[MT6991_DEEP_MEMIF].ack = mtk_sp_clean_written_buffer_ack;
	afe->memif[MT6991_FAST_MEMIF].fast_palyback = 1;

	mutex_init(&afe->irq_alloc_lock);       /* needed when dynamic irq */

	/* init irq */
	afe->irqs_size = MT6991_IRQ_NUM;
	...
	/* others */
	afe->mtk_afe_hardware = &mt6991_afe_hardware;
	afe->memif_fs = mt6991_memif_fs;
	afe->irq_fs = mt6991_irq_fs;
	afe->get_dai_fs = mt6991_get_dai_fs;
	afe->get_memif_pbuf_size = mt6991_get_memif_pbuf_size;

	afe->runtime_resume = mt6991_afe_runtime_resume;
	afe->runtime_suspend = mt6991_afe_runtime_suspend;

	afe->request_dram_resource = mt6991_afe_dram_request;
	afe->release_dram_resource = mt6991_afe_dram_release;

	afe->copy = mt6991_afe_pcm_copy;
...
#if IS_ENABLED(CONFIG_DEBUG_FS)
	/* debugfs */
	afe->debug_cmds = mt6991_debug_cmds;
	afe->debugfs = debugfs_create_file("mtksocaudio",
					   S_IFREG | 0444, NULL,
					   afe, &mt6991_debugfs_ops);
#endif
...
static int mt6991_afe_pcm_dev_remove(struct platform_device *pdev)
{
	struct mtk_base_afe *afe = platform_get_drvdata(pdev);

	pm_runtime_disable(&pdev->dev);
	if (!pm_runtime_status_suspended(&pdev->dev))
		mt6991_afe_runtime_suspend(&pdev->dev);
...
static const struct of_device_id mt6991_afe_pcm_dt_match[] = {
	{ .compatible = "mediatek,mt6991-sound", },
	{},
};
MODULE_DEVICE_TABLE(of, mt6991_afe_pcm_dt_match);

static const struct dev_pm_ops mt6991_afe_pm_ops = {
	SET_RUNTIME_PM_OPS(mt6991_afe_runtime_suspend,
			   mt6991_afe_runtime_resume, NULL)
};

static struct platform_driver mt6991_afe_pcm_driver = {
	.driver = {
		.name = "mt6991-audio",
		.of_match_table = mt6991_afe_pcm_dt_match,
#if IS_ENABLED(CONFIG_PM)
		.pm = &mt6991_afe_pm_ops,
#endif
	},
	.probe = mt6991_afe_pcm_dev_probe,
	.remove = mt6991_afe_pcm_dev_remove,
};

module_platform_driver(mt6991_afe_pcm_driver);

MODULE_DESCRIPTION("Mediatek ALSA SoC AFE platform driver for 6991");
