...
COMMON_OPLUS_MODULES_LIST = [
    ...
    "//vendor/oplus/kernel/camera:oplus_camera_sgm38121_regulator",
    ...
    "//vendor/oplus/kernel/cpu/sched_ext:oplus_bsp_sched_ext",
...
def get_overlay_modules_list():
    ...
    if "oplus6899.config" in DEFCONFIG_OVERLAYS:
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_wl28681c1_regulator")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_dw9800s_24071")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_dw9800s_front_24071")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_dw9827c_24071")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_jd5516w_24071")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_aw36515_zhuquec1")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_gt9764v_24069")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_aw36515_knightm")
