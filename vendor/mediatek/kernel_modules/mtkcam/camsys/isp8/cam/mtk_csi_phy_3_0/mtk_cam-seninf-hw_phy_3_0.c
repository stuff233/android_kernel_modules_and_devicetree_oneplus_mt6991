...
static void csirx_phyA_dphy_setting(void *base, u64 data_rate, bool bw_need_changed)
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
{
...
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
{
	...
	if (!strcasecmp(_seninf_ops->iomem_ver, MT6991_IOMOM_VERSIONS)) {
		...
		if (data_rate < 2500000000) {
#ifndef OPLUS_FEATURE_CAMERA_COMMON
// modify for BrzB change BW 0x03
			SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_BW, 0x1);
#else /*OPLUS_FEATURE_CAMERA_COMMON*/
			if (bw_need_changed) {
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_BW, 0x3);
...
#else /*OPLUS_FEATURE_CAMERA_COMMON*/
			csirx_phyA_dphy_setting(baseA, data_rate, bw_need_changed);
			csirx_phyA_dphy_setting(baseB, data_rate, bw_need_changed);
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
		} else {
...
#else /*OPLUS_FEATURE_CAMERA_COMMON*/
			csirx_phyA_dphy_setting(base, data_rate, bw_need_changed);
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
		}
	} else {
		data_rate = ctx->mipi_pixel_rate * bit_per_pixel;
