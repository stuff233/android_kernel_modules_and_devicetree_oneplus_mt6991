...
struct mtk_cam_ctx {
	...
	bool is_pre_alloc_worker;
	struct kthread_worker *sensor_pre_worker;
	struct kthread_worker *flow_pre_worker;
	struct kthread_worker *done_pre_worker;
	struct kthread_worker *tuning_pre_worker;
#endif
