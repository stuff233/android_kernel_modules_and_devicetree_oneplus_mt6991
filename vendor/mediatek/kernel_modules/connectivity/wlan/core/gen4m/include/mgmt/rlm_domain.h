...
#if (CFG_SUPPORT_WIFI_6G == 1)
struct oplus_country_pwr_limit_6E {
    uint32_t project;
    uint16_t tableSize;
    struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION_6E *pwrLimitTable6E;
};
struct oplus_country_pwr_limit_Legacy_6G {
    uint32_t project;
    uint16_t tableSize;
    struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION_LEGACY_6G *pwrLimitTableLegacy_6G;
};
#if (CFG_SUPPORT_PWR_LIMIT_EHT == 1)
struct oplus_country_pwr_limit_EHT_6G {
    uint32_t project;
    uint16_t tableSize;
    struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION_EHT_6G *pwrLimitTableEHT_6G;
};
#endif /* CFG_SUPPORT_PWR_LIMIT_EHT */
#endif /* CFG_SUPPORT_WIFI_6G */
...
struct oplus_country_pwr_limit_default_emi {
    uint32_t project;
    struct COUNTRY_POWER_LIMIT_TABLE_DEFAULT_INFO *pwrLimitDefaultTableEmi;
};

struct oplus_country_pwr_limit_configuration_emi {
    uint32_t project;
    struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION_INFO *pwrLimitConfigurationTableEmi;
};
