...
#define MAX_PRED_BITRATE_NUM 20
#endif
...
/* P_P2P_FSM_INFO_T prP2pFsmInfo; */
	...
	u_int8_t fgUseDetailedTxHangUEvent;
...
#define INVALID_TX_DELAY 0xFFFFFFFF
	...
	u_int8_t ucCountryPwrLimitCtrl;
...
__KAL_ATTRIB_PACKED_FRONT__
struct EMI_BITRATE_INFO {
	struct STATS_LLS_TX_BIT_RATE arBrHistory[MAX_PRED_BITRATE_NUM];
	uint8_t ucCnt;
...
struct ADAPTER {
	...
	uint32_t u4PktPIDCnt[WTBL_SIZE][ENUM_PKT_FLAG_NUM];
#endif /* CFG_SUPPORT_LIMITED_PKT_PID */
	...
	struct EMI_BITRATE_INFO arBitrateInfo[MAX_BSSID_NUM];
#if CFG_SUPPORT_LLS && CFG_REPORT_TX_RATE_FROM_LLS
	u_int8_t fgTxRateOffsetMapped;
#endif
	u_int8_t fgPredBrOffsetMapped;
#endif
