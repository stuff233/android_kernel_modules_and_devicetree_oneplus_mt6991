...
#define INIT_INT(__FEATURE, __KEY, __VAL, __DBG) \
	 ...
	 * 0: none disable
	 */
	INIT_UINT(prWifiVar->u2Ap2gDisableChannel, "Ap2gDisableChannel", 0,
		  FEATURE_TO_CUSTOMER);
...
#undef __STR_MIN_RESERVED
	...
	INIT_UINT(prWifiVar->fgDisGTKCipherCheck, "DisGTKCipherCheck", 1,
		  FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->fgDisSecurityCheck, "DisSecurityCheck", 1,
		  FEATURE_TO_CUSTOMER);
	...
	INIT_UINT(prWifiVar->fgUseDetailedTxHangUEvent,
		"UseDetailedTxHangUEvent", FEATURE_DISABLED,
		FEATURE_TO_CUSTOMER);
