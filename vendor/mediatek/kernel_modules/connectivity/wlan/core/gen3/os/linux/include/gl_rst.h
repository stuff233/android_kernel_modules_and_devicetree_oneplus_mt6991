...
extern INT_32 mtk_wcn_wmt_msgcb_unreg(ENUM_WMTDRV_TYPE_T eType);
extern INT_32 mtk_wcn_wmt_msgcb_reg(ENUM_WMTDRV_TYPE_T eType, PF_WMT_CB pCb);
extern INT_32 mtk_wcn_set_connsys_power_off_flag(INT_32 value);
extern INT_32 mtk_wcn_wmt_assert_timeout(ENUM_WMTDRV_TYPE_T type, UINT32 reason, INT_32 timeout);
extern INT_32 mtk_wcn_wmt_do_reset(ENUM_WMTDRV_TYPE_T type);
#endif
