...
typedef struct _PARAM_AUTH_EVENT_T {
	...
	PARAM_AUTH_REQUEST_T arRequest[];
...
typedef struct _PARAM_CAPABILITY_T {
	...
	PARAM_AUTH_ENCRYPTION_T arAuthenticationEncryptionSupported[];
...
typedef struct _PARAM_NETWORK_ADDRESS {
	...
	UINT_8 aucAddress[];	/* actually AddressLength bytes long */
