...
/* ----------------------------AC247 oplus define ----------------------- */
#define AC247_GAMMA_COMPENSATION_READ_LENGTH 6
#define AC247_GAMMA_COMPENSATION_READ_RETRY_MAX 5
#define AC247_GAMMA_COMPENSATION_CMD_INDEX 1
#define AC247_GAMMA_COMPENSATION_REG_INDEX1 0
#define AC247_GAMMA_COMPENSATION_REG_INDEX2 1
#define AC247_GAMMA_COMPENSATION_REG_INDEX3 2
#define AC247_GAMMA_COMPENSATION_REG_INDEX4 3
#define AC247_GAMMA_COMPENSATION_REG_INDEX5 4
#define AC247_GAMMA_COMPENSATION_REG_INDEX6 5
