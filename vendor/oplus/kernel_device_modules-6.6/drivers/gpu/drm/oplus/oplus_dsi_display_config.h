...
struct dsi_panel_lcm {
	...
	int lfcc_dbv_cfg;
	bool need_aod_off_insert_black_frame;
...
extern u8 oplus_dsi_panel_get_panel_flag(void *dsi);
extern u8 oplus_dsi_panel_get_panel_id1(void *dsi);
extern u8 oplus_dsi_panel_get_panel_id2(void *dsi);
extern u8 oplus_dsi_panel_get_panel_id3(void *dsi);
extern u32 oplus_dsi_panel_get_panel_info(void *dsi);
