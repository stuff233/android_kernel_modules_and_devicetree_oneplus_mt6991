...
#define DRIVER_NAME "gt9764v_24069"

#define LOG_INF(format, args...)                                               \
	pr_info(DRIVER_NAME " [%s] " format, __func__, ##args)

#define GT9764_NAME				"gt9764v_24069"
#define GT9764_MAX_FOCUS_POS			1023
#define GT9764_ORIGIN_FOCUS_POS			0
/*
...
static int gt9764v_set_lock(struct gt9764_device *gt9764, void *arg)
{
	struct i2c_client *client = v4l2_get_subdevdata(&gt9764->sd);
	int *val = (int *)arg;
...
static long gt9764v_ops_core_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	...
	switch (cmd) {
		case VIDIOC_MTK_SET_LOCK:
			gt9764v_set_lock(gt9764, arg);
		break;
		default:
			LOG_INF("gt9764v_ops_core_ioctl cmd error");
	}
	return 0;
}
...
static const struct of_device_id gt9764_of_table[] = {
	{ .compatible = "oplus,gt9764v_24069" },
	{ },
};
