...
#define EMIRAMAIN_STEREO_START_ADDR            (0x3BC0)
#define EMIRAMAIN_STEREO_MT_START_ADDR         (0x4260)
#define EMIRAMAIN_STEREO_MT_105CM_START_ADDR   (0x4900)
#define EMIRAMAIN_AESYNC_START_ADDR            (0x4FA0)

#define KKTHMAIN_STEREO_START_ADDR            (0x3BC0)
#define KKTHMAIN_STEREO_MT_START_ADDR         (0x4260)
#define KKTHMAIN_STEREO_MT_105CM_START_ADDR   (0x4900)
#define KKTHMAIN_AESYNC_START_ADDR            (0x4FA0)
#define KKTHUWIDE_STEREO_START_ADDR          (0x2780)
#define KKTHUWIDE_STEREO_105CM_START_ADDR    (0xE400)
#define KKTHUWIDE_AESYNC_START_ADDR          (0x2D90)
#define KKTHTELE_STEREO_START_ADDR          (0x22C0)
#define KKTHTELE_STEREO_105CM_START_ADDR    (0x2640)
#define KKTHTELE_AESYNC_START_ADDR          (0x2290)
#define KKTHTELE_EEPROM_LOCK_REGISTER  (0xE000)
...
#define KNIGHTMFRONT_STEREO_START_ADDR      (0X2200)
#define KNIGHTMFRONT_AESYNC_START_ADDR      (0x3800)
...
#define SAYRAMMAIN_STEREO_START_ADDR            (0x3BC0)
#define SAYRAMMAIN_STEREO_MT_START_ADDR         (0x4260)
#define SAYRAMMAIN_STEREO_MT_105CM_START_ADDR   (0x4900)
#define SAYRAMMAIN_AESYNC_START_ADDR            (0x4FA0)
#define SAYRAMUWIDE_STEREO_START_ADDR          (0x2780)
#define SAYRAMUWIDE_STEREO_105CM_START_ADDR    (0xE400)
#define SAYRAMUWIDE_AESYNC_START_ADDR          (0x2D90)
#define SAYRAMTELE_STEREO_START_ADDR           (0X3BC0)
#define SAYRAMTELE_STEREO_105CM_START_ADDR     (0x3F40)
#define SAYRAMTELE_STEREO_120CM_START_ADDR     (0x42C0)
#define SAYRAMTELE_AESYNC_START_ADDR           (0x3B80)
#define SAYRAMUTELE_STEREO_START_ADDR          (0X3C00)
#define SAYRAMUTELE_STEREO_105CM_START_ADDR    (0xE400)
#define SAYRAMUTELE_AESYNC_START_ADDR          (0x30C5)

#define TARGAMAIN_STEREO_START_ADDR            (0x2B00)
#define TARGAMAIN_STEREO_MT_START_ADDR         (0x31C0)
#define TARGAMAIN_STEREO_MT_105CM_START_ADDR   (0x6400)
#define TARGAMAIN_AESYNC_START_ADDR            (0x3880)
#define TARGAFRONT_STEREO_START_ADDR           (0X2200)
#define TARGAFRONT_AESYNC_START_ADDR           (0x3800)
...
enum SENSOR_SCENARIO_ENUM{
		...
		DCG_MASK = MASK_BASE << 8,
};

enum SEAMLESS_FEATURE_SENSOR_SCENARIO {
		SENSOR_SCENARIO_UNDEFINED = 0,
		SENSOR_SCENARIO_BIN,
		SENSOR_SCENARIO_FULL_4CELL,
		SENSOR_SCENARIO_FULL_NCELL,
		SENSOR_SCENARIO_FULL_BAYER,
		SENSOR_SCENARIO_CROP_4CELL,
		SENSOR_SCENARIO_CROP_2X_NCELL,
		SENSOR_SCENARIO_CROP_4X_NCELL,
		SENSOR_SCENARIO_CROP_BAYER,
		SENSOR_SCENARIO_STAGGER_2EXP_BAYER,
		SENSOR_SCENARIO_STAGGER_2EXP_CROP_4CELL,
		SENSOR_SCENARIO_STAGGER_3EXP_BAYER,
		SENSOR_SCENARIO_LBMF_2EXP_BAYER,
		SENSOR_SCENARIO_LBMF_2EXP_CROP_BAYER,
		SENSOR_SCENARIO_LBMF_2EXP_CROP_4CELL,
		SENSOR_SCENARIO_DCG_SENSOR_MERGE_12BIT_BAYER,
		SENSOR_SCENARIO_DCG_SENSOR_MERGE_14BIT_BAYER,
		SENSOR_SCENARIO_DCG_AP_MERGE_2EXP_BAYER,
		SENSOR_SCENARIO_DCG_AP_MERGE_2EXP_CROP_BAYER,
		SENSOR_SCENARIO_CUSTOMER_ASSIGN,
		SENSOR_SCENARIO_BIN_2M,
		SENSOR_SCENARIO_BIN_3M,
		SENSOR_SCENARIO_BIN_8M,
		SENSOR_SCENARIO_FAEC,
};
